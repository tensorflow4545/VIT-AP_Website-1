...
const Gallery = () => {
    return (
        <div className='max-w-[1560px] w-[100%] min-h-[500px] h-[100%] '>
            <div className='px-[10px] ls:px-[50px] md:px-[100px] py-[50px] flex flex-col gap-4'>
                <h1 className='text-[46px] font-Emilio text-[#650010] font-bold'>Gallery</h1>
                <div className='flex flex-wrap justify-center items-center gap-6'>
                    <div className='max-w-[150px] lx:max-w-[390px] w-[100%] min-h-[110px] ls:min-h-[230px] h-[100%] relative'>
