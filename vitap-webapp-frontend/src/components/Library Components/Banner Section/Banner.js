...
const LibBanner = () => {
    return (
        <>
            <div className='max-w-[1560px] w-[100%] min-h-[600px] lx:min-h-[500px] h-[100%] hidden ls:block'>
                <div className='relative'>
                    ...
                    <div className='flex max-w-[1560px] w-[100%] min-h-[600px] lx:min-h-[500px] h-[100%] absolute top-0 left-0 px-[50px] md:px-[100px] py-[40px] gap-3 md:gap-5'>
            ...
            <div className='w-full max-h-[900px] bg-[#FDFEFF] block ls:hidden'>
