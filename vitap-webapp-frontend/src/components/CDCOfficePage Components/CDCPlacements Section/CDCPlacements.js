...
const CDCPlacements = () => {
    return (
        <>
            <div className='max-w-[1560px] mt-[50px] w-[100%] px-[40px] min-h-[450px] lg:min-h-[500px] h-[100%] hidden lg:block'>
                <div className='relative'>
                    <div className='flex max-w-[1560px] w-[100%] min-h-[450px] lg:min-h-[500px] h-[100%] absolute top-0 left-0 lg:px-[50px] md:px-[100px] px-[30px] py-[20px] lg:py-[40px] gap-3 md:gap-5 flex-col'>
                        <div className='flex flex-col justify-center items-start'>
                            <h1 className='text-[24px] lg:text-[46px] font-Emilio text-[#650010] font-bold pb-2'>Co-ordinators Placements</h1>
                        </div>
                        <div className='grid grid-cols-2 lg:grid-cols-4 justify-center items-center gap-5 text-center'>
            ...
            <div className='block lg:hidden max-h-[750px] w-full'>
