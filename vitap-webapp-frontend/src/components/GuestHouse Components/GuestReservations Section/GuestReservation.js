...
const GuestReservation = () => {
    return (
<<<<<<< HEAD
        <div className='max-w-screen w-[100%] min-h-[800px] h-[100%] flex justify-center items-center'>
=======
        <div className='max-w-[1560px] w-[100%] min-h-[800px] h-[100%] flex justify-center items-center'>
>>>>>>> aws-build-branch
            <div className='max-w-[1340px] w-[100%] min-h-[700px] h-[100%] flex flex-col gap-4 text-start justify-center items-start p-[50px] md:p-0'>
