    ...
    return (
        <div className='max-w-[1560px] w-[100%] min-h-[1100px] h-[100%] bg-gradient-to-b from-[#FCE3E5] to-white px-[50px] md:px-[100px] py-[80px] mt-[30px] flex flex-col'>
            ...
            <div className='grid grid-rows-6 mt-[20px] max-h-[700px] h-[100%]'>
                <div className='grid grid-cols-3 text-center bg-[#650010] text-white p-5 text-[12px] sm:text-[22px] font-semibold'>
                    <h1>Category</h1>
                    <h1>Room Rent Including Taxes</h1>
                    <h1>Remarks</h1>
                </div>
                <div className='grid grid-cols-3 text-center bg-backgroundRed text-[#000] p-5 text-[10px] min-h-[25px] sm:text-[18px] font-semibold'>
                    <h1>Executive Room (Including Breakfast)</h1>
                    <h1>2500</h1>
                    <h1>Single Occupancy</h1>
                </div>
                <div className='grid grid-cols-3 text-center bg-white text-[#000] p-5 text-[10px] min-h-[25px] sm:text-[18px] font-semibold'>
                    <h1>Executive Room (Including Breakfast)</h1>
                    <h1>3000</h1>
