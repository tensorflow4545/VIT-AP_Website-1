    ...
    <>
      ...
      <div className='w-full max-h-[800px] block ls:hidden'>
        <div className='flex flex-col gap-3 px-[30px] py-[20px]'>
          ...
          <div className='bg-[#FCE3E5] -mt-[70px]'>
            <p class="text-dark text-[16px] px-[20px] pt-[75px] pb-[20px] font-montserrat">The VIT placement Cell is committed to offer its students a variety of opportunities to get placed with companies of their choice once their course gets over. Through arranging meetings with professional trainers and VIT alumni, the centre helps the students to prepare themselves for placement interviews in technical and HR aspects and also get well prepared for group discussions. The Career Development Centre (CDC) makes sure that the students get well-versed in Coding and aptitude skills, to perform better in tests and interviews.</p>
          </div>
        </div>
      </div>
    </>
