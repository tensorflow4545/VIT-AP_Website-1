...
const AdvantageFeatures = () => {
    return (
        <div className='max-w-[1560px] w-[100%] mx-auto max-h-[7500px] py-[40px]'>
            <h1 className='text-[24px] font-bold  lg:text-[46px] font-Emilio text-[#650010] py-5 lg:font-thin text-center'>Objectives Key Features</h1>
            <div className='lg:flex flex-col items-center justify-center gap-3 mx-10 hidden '>
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        ...
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            <h1 className='text-[26px] lg:text-[32px] font-Emilio text-[#650010]'>Unique Teaching-Learning Process</h1>
                ...
                <div className='min-h-[400px] w-[100%] py-[40px] flex  '>
                    <div className='basis-2/3 max-h-[400px] flex flex-col items-start justify-center border-2 border-[#655010]'>
                        <div className='px-[30px] flex'>
                            <div className='flex-1'>
                                <h1 className='text-[32px] lg:text-[32px] font-Emilio text-[#650010]'>Fully Flexible Credit System (FFCS® )</h1>
                    ...
                    <div className='basis-1/3'>
                        <div className='max-w-[550px] w-[100%] min-h-[400px] -ml-[150px] lg:-ml-[250px] relative mt-[60px]'>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        <div className='flex-1 '></div>
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            <h1 className='text-[26px] lg:text-[32px] font-Emilio text-[#650010]'>Engineering Clinics</h1>
                ...
                <div className='min-h-[400px] w-[100%] py-[40px] flex  '>
                    <div className='basis-2/3 max-h-[400px] flex flex-col items-start justify-center border-2 border-[#655010]'>
                        <div className='px-[30px] flex'>
                            <div className='flex-1'>
                                <h1 className='text-[32px] lg:text-[32px] font-Emilio text-[#650010]'>Co-op Programmes and Internships</h1>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        <div className='flex-1 '></div>
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            <h1 className='text-[26px] lg:text-[32px] font-Emilio text-[#650010]'>Sports</h1>
                ...
                <div className='min-h-[400px] w-[100%] py-[40px] flex  '>
                    <div className='basis-2/3 max-h-[400px] flex flex-col items-start justify-center border-2 border-[#655010]'>
                        <div className='px-[30px] flex'>
                            <div className='flex-1'>
                                <h1 className='text-[26px] lg:text-[32px] font-Emilio text-[#650010]'>Clubs and Chapters</h1>
                                <p className='text-[#000] font-Montserrat text-[16px] lg:text-[18px] font-thin text-justify'>At VIT-AP, there exists a symbiotic relationship between learning and enjoyment. With a stimulating community of students, various opportunities are provided to interact with students from diverse backgrounds. Several club activities eventually lead them to develop a crucial skillset comprising team-work, leadership, and event management.</p>
                            </div>
                            <div className='flex-1'></div>
                        </div>
                    </div>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        <div className='flex-1 '></div>
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            <h1 className='text-[26px] lg:text-[32px] font-Emilio text-[#650010]'>Stellar Placements</h1>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        <div className='flex-1 '></div>
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            <h1 className='text-[26px] lg:text-[32px] font-Emilio text-[#650010]'>Community Development</h1>
                ...
                <div className='min-h-[400px] w-[100%] py-[40px] flex  '>
                    <div className='basis-2/3 max-h-[400px] flex flex-col items-start justify-center border-2 border-[#655010]'>
                        <div className='px-[30px] flex'>
                            <div className='flex-1'>
                                <h1 className='text-[25px] lg:text-[28px] font-Emilio text-[#650010]'>Infrastructure and Facilities</h1>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        <div className='flex-1 '></div>
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            <h1 className='text-[26px] lg:text-[32px] font-Emilio text-[#650010]'>Mentoring Programme</h1>
                ...
                <div className='min-h-[400px] w-[100%] py-[40px] flex  '>
                    <div className='basis-2/3 max-h-[400px] flex flex-col items-start justify-center border-2 border-[#655010]'>
                        <div className='px-[30px] flex'>
                            <div className='flex-1'>
                                <h1 className='text-[32px] lg:text-[32px] font-Emilio text-[#650010]'>Qualified and Caring Faculty</h1>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        <div className='flex-1 '></div>
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            <h1 className='text-[26px] lg:text-[32px] font-Emilio text-[#650010]'>Well-connected Alumni Network</h1>
            ...
            <div className='flex flex-col items-center justify-center lg:hidden gap-5 px-[20px]'>
