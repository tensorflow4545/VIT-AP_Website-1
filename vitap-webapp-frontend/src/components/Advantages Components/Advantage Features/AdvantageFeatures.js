                    ...
                    <div className='basis-2/3 max-h-[400px] flex flex-col items-start justify-center border-2 border-[#655010]'>
                        <div className='px-[30px] flex'>
                            <div className='flex-1'>
                                ...
                                <p className='text-[#000] font-Montserrat text-[18px] font-thin text-left'>Even before the students step out into the real world, we ensure they are industry -ready through our mandatory internships which are carried out as part of the programmes. The aim is to provide industrial exposure at an early stage in order to acquire a better understanding of the industry expectations.</p>
                            </div>
                            <div className='flex-1'></div>
                        </div>
                    </div>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        ...
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            ...
                            <p className='text-[#000] font-Montserrat text-[18px] font-thin text-left'>At VIT-AP, we believe that sound mental and good physical health are crucial for holistic development. With a strong emphasis on recreation of students, VIT-AP students, faculty and staff are provided facilities which keeps them active, spirited, involved, and healthy. Several intramural sports events are organised where students compete in cricket, badminton, volleyball, chess etc. Apart from intramural sports, different colleges and universities also participate in our in-house Sports and Cultural fest VITopia.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='basis-2/3 max-h-[400px] flex flex-col items-start justify-center border-2 border-[#655010]'>
                        <div className='px-[30px] flex'>
                            <div className='flex-1'>
                                ...
                                <p className='text-[#000] font-Montserrat text-[16px] lx:text-[18px] font-thin text-left'>At VIT-AP, there exists a symbiotic relationship between learning and enjoyment. With a stimulating community of students, various opportunities are provided to interact with students from diverse backgrounds. Several club activities eventually lead them to develop a crucial skillset comprising team-work, leadership, and event management.</p>
                            </div>
                            <div className='flex-1'></div>
                        </div>
                    </div>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        ...
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            ...
                            <p className='text-[#000] font-Montserrat text-[18px] font-thin text-left'>Seize the Unbeatable Placement Advantage [700+ companies, multiple offers]. At VIT-AP, students are part of serious and rigorous programmes which do not compromise on quality. As a result, they receive unparalleled placement opportunities through the well-connected placement cell.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        ...
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            ...
                            <p className='text-[#000] font-Montserrat text-[18px] font-thin text-left'>The aim of reaching out to communities is to serve emerging rural needs, challenges, and help in social sustainability. It is also to promote sustainable rural development through participative planning, capacity building, effective networking, research and innovative efforts.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='min-h-[400px] w-[100%] relative py-[40px] flex '> 
                    ...
                    <div className='basis-2/3 max-h-[400px] bg-[#FCE3E5] flex justify-center items-center -z-20'>
                        ...
                        <div className='flex-1 flex flex-col justify-center items-start -ml-[200px] px-[10px] md:px-[40px]'>
                            ...
                            <p className='text-[#000] font-Montserrat text-[18px] font-thin text-left'>A unique mentoring programme is in place at our institute, where, a faculty member is assigned to a group of students as a mentor. The mentor not only helps a student in making informed decisions about his or her academic progress, but also acts as a local guardian.</p>
                        </div>
                    </div>
                </div>
