...
export default function Hero(){
  return(
    <>
        ...
        <div className={`w-full h-[400px] ${style.welcome} relative`}>
          <Image src={headerImg} fill/>
        </div>

        <div className="bg-white h-[550px] ">
        <div className="w-full h-[400px] flex items-center justify-center">
        <div className={`w-[560px] h-[300px] ${style.vlogo} relative`}>
              <Image src={vlogo} fill />
        </div>
        </div>
        ...
        <div className="sm:hidden relative">
         <div className={`w-full h-[144px] ${style.mwelcome} relative`}>
          <Image src={headerImg} fill />
         </div>

         <div className="bg-white h-[550px]">
        <div className="w-full h-[400px] flex items-center justify-center">
        <div className={`w-[200px] h-[107px] ${style.mvlogo} relative`}>
              <Image src={vlogo} fill />
        </div>
        </div>
