    ...
    return(
        <>
            ...
            <div class="w-full h-max px-[80px] bg-white">
               ...
               <p class="text-black text-[20px] font-[400px]">Our institute fosters the growth of counseling programs as they play a vital role in the success and overall satisfaction of the student community. Counseling services can be highly beneficial for students, offering a range of advantages that contribute to their personal, academic, and emotional well-being. In addition to that, providing counseling services for university staff and faculty acknowledges the importance of their mental health and well-being, which, in turn, can lead to a more productive and positive work environment for everyone.</p>
               </div>
               {/* Background image div */}
