  ...
  return (
    <div className="bg-white h-screen">
      ...
      <div className="flex ml-[240px] mt-[20px]">
        <div className="w-[320px] h-[450px] bg-white ml-[24px] border-b shadow-2xl border-gray-800 section group">
          <Image
            src={news1}
            width={392}
            height={311}
        ...
        <div className="w-[320px] h-[450px] bg-white ml-[35px] border-b shadow-2xl border-gray-800 section group">
          <Image
            src={news2}
            width={392}
            height={311}
