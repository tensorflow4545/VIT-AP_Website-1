...
import imagelogo from "../../../assets/images/logos/vitaplogored.png"
import "./navbarBottom.css";
import { useState, useEffect } from "react";
import NavbarBottomItem from "./NavbarBottomItem";

const NavbarBottomPages = () => {
  ...
  return (
    <>
      <div className="sticky top-0 z-50 sm:hidden md:block ">
        {/* {"bg-opacity-50 "} */}
        {/* Increased z-index to 30 */}
        <div
          className={`bg-gray-900 ${navbar ? "navbar active" : "navbar"
            }  w-full h-[74px] shadow-2xl absolute md:flex font-Montserrat font-medium text-primary text-[20px]`}
        >
          <ul className="flex flex-row  items-center pl-[33px] w-full justify-between pr-[76px]">
            <li className="mr-[100px] w-[190px]">
              <a href="/">
                <Image alt="A descriptive text here" src={imagelogo} />
              </a>
            </li>
...
export default NavbarBottomPages;
