          ...
          <div className="min-h-[1500px]w-full absolute pl-[75px] max-lx:pl-[40px] pt-[55px] max-lx:pt-[30px] ">
            ...
            {programmesOffered.map((program) =>
              program.field === active ? (
                <h1 key={program.id} className="py-[19px] max-w-[432px] max-lx:py-[16px] text-[#51060D] text-[18px] max-lx:text-[15px] font-semibold capitalize border border-l-0 border-t-0 border-r-0 border-b-gray-500">
                  {program.title}
                </h1>
              ) : (
                ""
