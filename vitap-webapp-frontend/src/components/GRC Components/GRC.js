  ...
  return (
    <>
      <div className="">
        ...
        <p className="text-[44px] font-Emilio text-[#650010] mt-10 font-bold max-w-[813px] min-h-[44px] mx-auto">
          Grievance Redressal Committee (GRC)
        </p>
        <p className="mt-[15px] text-center text-[18px] font-Montserrat max-w-[813px] min-h-[60px] mx-auto">
        ...
        <p className=" font-Montserrat font-bold mt-[30px] text-left text-[22px] px-[30px] lg:px-[50px] md:px-[100px]">
          In accordance to the above the following are nominated as the members
          of the committee.
        </p>

        <div className='grid grid-rows-10 mt-[20px] max-h-[1600px] px-[30px] lg:px-[50px] md:px-[100px] py-[40px]'>
...
<tbody>
        ...
        <p className="font-bold mt-[32px] text-[22px] font-Montserrat px-[30px] lg:px-[50px] md:px-[100px]">
        ...
        <div className="bg-[#E6CFCF] max-h-[800px] mt-[30px] flex justify-center items-center rounded-tr-3xl rounded-bl-3xl">
        ...
        <div className="mx-auto max-w-[1016px] h-[563px] shadow-2xl mt-[36px] border flex relative">
          ...
          <div className="max-w-[300px] lg:max-w-[360px] mx-auto h-[369px] mt-[97px] bg-[#F9C6CB] absolute top-[3%] right-[10%] rounded">
            ...
            <div className="text-[#650010] flex text-[20px] pb-[35px] px-[20px] items-center">
              <RxEnvelopeClosed />
