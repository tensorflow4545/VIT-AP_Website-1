...
const UREtable = () => {
    ...
    return (
        <div className='max-w-[1560px] w-[100%] min-h-[900px] h-[100%] px-[30px] lg:px-[50px] md:px-[100px] py-[40px] flex -z-10 gap-3 flex-col'>
            <div className='flex flex-col gap-3'>
                <h1 className='text-[24px] lg:text-[46px] font-Emilio text-[#650010] font-bold'>URE(Undergraduate Research Experience) Projects</h1>
                <p className='text-[16px] lg:text-[20px] font-Montserrat text-[#000]'>The following is the list of URE001 (Undergraduate Research Experience) projects that have been successfully defended before the evaluation panels and recommended for the award of URE001 to be printed in their grade sheet.</p>
            </div>
            ...
            <div>
                <p className='text-[16px] lg:text-[20px] font-Montserrat'>Congratulations to all the candidates and guides for putting up a great effort. Many of these projects culminated in a Scopus indexed publication.</p>
            </div>
        </div>
    )
}
