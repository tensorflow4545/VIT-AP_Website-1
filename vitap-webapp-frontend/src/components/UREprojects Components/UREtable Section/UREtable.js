...
const UREtable = () => {
    ...
    return (
        <div className='max-w-[1560px] w-[100%] min-h-[900px] h-[100%] bg-backgroundRed2 px-[50px] md:px-[100px] py-[40px] flex -z-10 gap-3 mt-[50px] flex-col'>
            ...
            <div className='grid grid-rows-10 mt-[20px] max-h-[1200px] h-[100%]'>
                <div className='grid grid-cols-5 text-center bg-[#650010] text-white p-5 text-[14px] md:text-[20px] font-semibold'>
                    <h1>S.No</h1>
                    <h1>Project Code</h1>
                    <h1>Project Name</h1>
                    <h1>Students</h1>
                ...
                <div className='grid grid-cols-5 text-center bg-backgroundRed text-[#000] p-5 text-[14px] md:text-[16px] font-semibold'>
                    <h1>1</h1>
                    <h1>URE001201901</h1>
                ...
                <div className='grid grid-cols-5 text-center bg-white text-[#000] p-5 text-[14px] md:text-[16px] font-semibold'>
                    <h1>1</h1>
                    <h1>URE001201901</h1>
                    <h1>Analysis of Architectures: Memristor Bridge Synapse</h1>
                    <h1>Rohit Bhargav Peesa</h1>
