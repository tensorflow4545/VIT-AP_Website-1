...
const UREtable = () => {
    ...
    return (
        <div className='max-w-[1560px] w-[100%] min-h-[900px] h-[100%] bg-backgroundRed2 px-[30px] ls:px-[50px] md:px-[100px] py-[40px] flex -z-10 gap-3 mt-[50px] flex-col'>
            ...
            <div className='grid grid-rows-10 mt-[20px] max-h-[1600px] '>
                ...
                <div className='grid grid-cols-5 text-center bg-backgroundRed text-[#000] p-5 text-[7px] ls:text-[14px] md:text-[16px] font-semibold'>
                    <h1>1</h1>
                    <h1>URE001201901</h1>
