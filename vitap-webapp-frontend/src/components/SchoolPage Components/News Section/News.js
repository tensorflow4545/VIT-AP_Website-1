      ...
      <div class="w-full h-[800px] bg-white">
        ...
        <div className="flex flex-row items-center justify-between mb-10">
          ...
          <div className="flex flex-row relative items-center justify-end w-[100px] transition-all duration-300 ease-in group mr-[30px] ">
            <div className="Rectangle91 w-[32px] h-[30px] left-[40px] top-[-3px] absolute bg-red-950 opacity-20 transition-transform group-hover:left-[-10px] group-hover:w-[90px] group-hover:transition-all group-hover:duration-300 group-hover:ease-in-out "></div>
