...
const SubgalleryHeader = () => {
    return (
        <div className='w-full h-[338px] bg-[#E6CFCF] flex justify-center items-end'>
            <div className='mx-[50px] lg:mx-[100px] my-[60px] w-full flex items-end justify-between'>
                <div>
                    <h1 className='text-[72px] lg:text-[96px] text-[#5C0E14] font-Emilio font-bold capitalize'>Gallery</h1>
                    <div className='flex items-center justify-center gap-2 lg:gap-4'>
                        <Link href="/" className='text-[16px] lg:text-[18px] font-Montserrat'>Events at VIT- Main Gallery</Link>
                        ...
                        <Link href={"/"} className='text-[16px] lg:text-[18px] font-Montserrat'>Campus Info</Link>
                    </div>
                </div>
                <div>
                    <button className='w-[255px] h-[51px] bg-[#650010] flex items-center justify-center gap-6 text-white'>Show Slideshow <svg xmlns="http://www.w3.org/2000/svg" width="16" height="19" viewBox="0 0 16 19" fill="none">
