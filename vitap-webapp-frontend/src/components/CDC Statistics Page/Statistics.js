    ...
    <>
      <div className={`${styles.container}`}>
        <div className="relative">
          <Image src={banner} className={`${styles.banner} w-[100%]`} />
          <div className="absolute inset-0 bg-gradient-to-r from-gray-900 via-gray-900 to-gray-900 opacity-50"></div>
          <div className="absolute inset-0">
            <p
              className={`${styles.heading} absolute font-Emilo text-white opacity-100 font-bold text-[44px] mt-[274px] ml-[34px]`}
            >
              Statistics
            </p>
            <div
        ...
        <div>
          <p
            className={`${styles.head} text-[58px] text-[#51060D] font-Emilo mt-[96px] ml-[108px]`}
          >
            Statistics
          </p>
          <div className={`${styles.imgdiv} flex ml-[108px] mt-[36px]`}>
            <Image src={img1} className={`${styles.img1}`} />
            <Image
              src={img2}
              width={554}
              height={393}
              className={`${styles.img2} ml-[134px]`}
            />
          </div>
        </div>
        <div className="mt-[70px] bg-[#F3F4F8] flex items-center justify-center border">
          <div>
            <p
              className={`${styles.head} text-[58px] text-[#51060D] font-Emilo mt-[96px]`}
            >
              Average CTC
            </p>
            <Image src={s1} className={`${styles.img3} mt-[36px]`} />
          </div>
        </div>
        <div className="mt-[70px] flex items-center justify-center border">
          <div>
            ...
            <Image src={s2} className={`${styles.img3} mt-[36px]`} />
          </div>
        </div>
        <div className="mt-[70px] bg-[#F3F4F8] flex items-center justify-center border">
          <div>
            ...
            <Image src={s3} className={`${styles.img3} mt-[36px]`} />
          </div>
        </div>
        <div className="mt-[70px] flex items-center justify-center border-b-0">
          <div>
            ...
            <Image src={s4} className={`${styles.img3} mt-[36px]`} />
          </div>
        </div>
        <div className="mt-[70px] bg-[#F3F4F8] flex items-center justify-center border">
          <div>
            ...
            <Image src={s5} className={`${styles.img3} mt-[36px]`} />
          </div>
        </div>
        <div className="mt-[70px] flex items-center justify-center border-b-0">
          <div>
            ...
            <Image src={companies} className={`${styles.img3} mt-[36px]`} />
          </div>
        </div>
        <div className="relative">
          <div
